        ...
        <div className="p-6">
          ...
          <nav className="space-y-6">
            ...
            <Link to="/about" className="flex items-center space-x-3 group">
              <span className="text-gray-400 group-hover:text-white">About</span>
            </Link>
            <Link to="/services" className="flex items-center space-x-3 group">
              <span className="text-gray-400 group-hover:text-white">Services</span>
            </Link>
            ...
            <Link to="/contact" className="flex items-center space-x-3 group">
              <span className="text-gray-400 group-hover:text-white">Contact</span>
            </Link>
          </nav>
          ...
          <div className="mt-6">
            <button 
              ...
              className="w-full px-4 py-2 rounded ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-gray-300 text-gray-900'}"
            >
